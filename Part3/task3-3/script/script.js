        ...
        return {
            ...
            lockHead: function () {
                var bodyScrollTop = document.body.scrollTop,
                    tableOffsetHeight = this.table.offsetHeight,
                    tableHeadHeight = this.table.firstElementChild.offsetHeight,
                    tableLastRowHeight = this.table.lastElementChild.offsetHeight;
                if(bodyScrollTop > this.table.offsetTop && (bodyScrollTop < (tableOffsetHeight + tableHeadHeight + tableLastRowHeight))) {
                    this.table.firstElementChild.classList.add("lock-head");
                } else if(bodyScrollTop < this.table.offsetTop) {
                    this.table.firstElementChild.classList.remove("lock-head");
                } else if(bodyScrollTop > (tableOffsetHeight + tableHeadHeight + tableLastRowHeight)) {
                    this.table.firstElementChild.classList.remove("lock-head");
                }
            },
            
            addEvent: function () {
                document.body.onscroll = this.lockHead.bind(this);
            },
